...
def test_the_committed_seeds_carry_a_dated_premium_and_no_round_number():
    ...
    assert seen == 507        # 473, then seven Roche Phase 3 seeds, Elahere, Moderna's intismeran, five Lilly Phase 3 seeds, five more Phase 3 seeds (Sanofi, Pfizer, GSK) and thirteen more (GSK, Novartis, Pfizer, Sanofi), then dazodalibep, seltorexant, all 2026-09-24
