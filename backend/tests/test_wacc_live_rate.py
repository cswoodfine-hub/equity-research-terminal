...
def test_the_committed_seeds_carry_a_dated_premium_and_no_round_number():
    ...
    assert seen == 526        # 473, then seven Roche Phase 3 seeds, Elahere, Moderna's intismeran, five Lilly Phase 3 seeds, five more Phase 3 seeds (Sanofi, Pfizer, GSK) and thirteen more (GSK, Novartis, Pfizer, Sanofi), then dazodalibep, seltorexant, zenagamtide, BMS-986489, rilvegostomig, cemdisiran, BMS-986353, povorcitinib, XL092, etavopivat, balcinrenone/dapagliflozin, empasiprubart, INCA033989, ziltivekimab, INCB123667, osavampator, INCA33890, direclidine, ABP 692, adimanebart, ABP 206, all 2026-09-24
