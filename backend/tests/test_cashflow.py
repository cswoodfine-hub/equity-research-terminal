...
def test_a_stale_debt_row_is_not_netted_against_this_years_cash(tmp_path):
    ...
    sheet with no debt tagged, net debt is minus the cash, and the basis says so."""
    ...
    assert got["inputs"]["debt_basis"].startswith("no debt tagged")
